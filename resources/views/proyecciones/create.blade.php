    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('proyecciones.store') }}" class="max-w-sm mx-auto">
                @csrf
                <div class="mb-5">
                    <x-input-label for="pelicula_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        ID la pelicula
                    </x-input-label>
                ...
                <div class="mb-5">
                    <x-input-label for="sala_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Sala
                    </x-input-label>
